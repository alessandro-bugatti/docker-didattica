...
<?php if (!$products): ?>
    <article>Non ci sono ancora prodotti. <a href="/prodotti/nuovo">Inserisci il primo prodotto</a>.</article>
<?php else: ?>
...
<table>
    ...
    <?php foreach ($products as $product): ?>
        <tr>
            ...
            <td>
                <div class="actions">
                    <a class="icon-button secondary outline" href="/prodotti/<?= (int) $product['id'] ?>/modifica" aria-label="Modifica <?= $this->e($product['nome']) ?>" title="Modifica">
                    ...
                    <form method="post" action="/prodotti/<?= (int) $product['id'] ?>/elimina" style="display:inline" onsubmit="return confirm('Eliminare questo prodotto?')">
